...
The dispersal of the DSM mosquitoes is balanced by the mortality rate. Because of this, the DSM are not \DIFdelbegin \DIFdel{really }\DIFdelend expected to disperse far from their release site, with the expected number of mosquitoes per cell delineated by the red and orange contours in Figure \ref{fig:plotSpread}. For instance, while the spread is expected to extend on average to up to $500$m away from the release location by day $2$ (with \DIFdelbegin \DIFdel{$1\%$ chance that it extends further }\DIFdelend \DIFaddbegin \DIFadd{at most a 1\% chance of finding a mosquito further away}\DIFaddend ), the extent then contracts quickly to a limited area (less than $250$m from release location) by day $5$, to finally about $150$m away from the release location at day $12$.
