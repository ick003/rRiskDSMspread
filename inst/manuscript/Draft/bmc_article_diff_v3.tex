...
%%DIFDELCMD < %%%
%\DIFdelendFL \DIFaddbeginFL \begin{tabular}{|cccccccc|}
%\DIFaddendFL \hline
%MRR & Date & Release site & Longitude & Latitude & \DIFdelbeginFL \DIFdelFL{Number released }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{N released }& \DIFaddFL{N captured }& \DIFaddFL{Distance}\DIFaddendFL \\ 
%\hline
%1 & 2013-10-09 & A & -4.4724 & 11.2347 & 1146 \DIFaddbeginFL & \DIFaddFL{32 }& \DIFaddFL{140}\DIFaddendFL \\ 
%1 & - & B & -4.4755 & 11.2342 & 1158 \DIFaddbeginFL & \DIFaddFL{9 }& \DIFaddFL{344}\DIFaddendFL \\ 
%1 & - & C & -4.4718 & 11.2318 & 1103 \DIFaddbeginFL & \DIFaddFL{6 }& \DIFaddFL{205}\DIFaddendFL \\ 
%2 & 2014-05-07 & A & -4.4724 & 11.2347 & 1878 \DIFaddbeginFL & \DIFaddFL{6 }& \DIFaddFL{94}\DIFaddendFL \\ 
%2 & - & B & -4.4755 & 11.2342 & 1655 \DIFaddbeginFL & \DIFaddFL{1 }& \DIFaddFL{266}\DIFaddendFL \\ 
%2 & - & C & -4.4718 & 11.2318 & 1734 \DIFaddbeginFL & \DIFaddFL{1 }& \DIFaddFL{193}\DIFaddendFL \\ 
%3 & 2014-09-04 & A & -4.4724 & 11.2347 & 1665 \DIFaddbeginFL & \DIFaddFL{56 }& \DIFaddFL{133}\DIFaddendFL \\ 
%3 & - & B & -4.4755 & 11.2342 & 1673 \DIFaddbeginFL & \DIFaddFL{4 }& \DIFaddFL{440}\DIFaddendFL \\ 
%3 & - & C & -4.4718 & 11.2318 & 1684 \DIFaddbeginFL & \DIFaddFL{13 }& \DIFaddFL{205}\DIFaddendFL \\ 
%4 & 2015-04-09 & A & -4.4724 & 11.2347 & 2107 \DIFaddbeginFL & \DIFaddFL{1 }& \DIFaddFL{55}\DIFaddendFL \\ 
%4 & - & B & -4.4755 & 11.2342 & 2013 \DIFaddbeginFL & \DIFaddFL{3 }& \DIFaddFL{386}\DIFaddendFL \\ 
%4 & - & C & -4.4718 & 11.2318 & 1953 \DIFaddbeginFL & \DIFaddFL{18 }& \DIFaddFL{190}\DIFaddendFL \\ 
%5 & 2015-10-09 & C & -4.4724 & 11.2347 & 5992 \DIFaddbeginFL & \DIFaddFL{18 }& \DIFaddFL{141}\DIFaddendFL \\ 
%\hline
%\end{tabular}
%\endgroup
%\caption{Summary of the MRR experiments conducted by \cite{Epopa2017} in Burkina Faso. \DIFaddbeginFL \DIFaddFL{The last column presents the average distance for recapture (in meters). }\DIFaddendFL We use the results of the first four experiments to parameterise our model and calculate Bayes factor for expert-derived priors, and use the fifth MRR experiment is to validate the model predictions.} 
%\label{tab:relLoc}
%\end{table}
...
\DIFaddbegin \DIFadd{In the posterior samples, we could identify a high level of correlation between the dispersal and swarm attraction parameters, as can be expected. The shape of this correlation means that high dispersal values correlates with low attraction, and vice-versa. The posterior distribution of dispersal and attraction are also linked to the range of the traps laid out in the field. With limited long range traps, no long range catches were made, limiting the ability of the model to capture possible high dispersal values. 
}\DIFaddend 
...
Mortality \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $\mu$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 0.16 \DIFaddbeginFL \DIFaddFL{(0.14) }\DIFaddendFL & 0.11 \DIFaddbeginFL \DIFaddFL{(0.10) }\DIFaddendFL & 0.24 \DIFaddbeginFL \DIFaddFL{(0.21)}\DIFaddendFL \\
Diffusion \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $D$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 127.0 & 113.7 & 140.7\\
Swarm attraction \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $\alpha$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 0.07 & 0.03 & 0.10\\
Swarm range \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $\sigma$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 33.9 & 19.8 & 56.1\\
Catchability psc \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $p_{psc}$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 0.18 & 0.11 & 0.25\\
Catchability cfr \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $p_{cfr}$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 0.03 & 0.02 & 0.05\\
Catchability ss \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $p_{ss}$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 0.29 & 0.24 & 0.34\\
\hline
\end{tabular}
\endgroup
\caption{\label{tble:sumStatPPpost} Summary statistics for the posterior distributions of the PDE model parameters inferred from the WT MRRs. \DIFaddbeginFL \DIFaddFL{In brackets in the first line we added the equivalent daily mortality rate value, for ease of comparison with other studies.}\DIFaddendFL }
\end{table}
...
\hline
Parameter & Mean & Q05 & Q95  \\\hline
Mortality \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $\mu$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 1.05 \DIFaddbeginFL \DIFaddFL{(0.65) }\DIFaddendFL & 0.19 \DIFaddbeginFL \DIFaddFL{(0.17) }\DIFaddendFL & 2.42 \DIFaddbeginFL \DIFaddFL{(0.91)}\DIFaddendFL \\
Diffusion \DIFdelbeginFL \DIFdelFL{(}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{- }\DIFaddendFL $D$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL & 753 $\times$ 10$^{3}$ & 8.77 & 112  $\times$ 10$^{4}$\\
\hline
\end{tabular}
\endgroup
\caption{\label{tble:sumStatPPpostbma} Updated statistics for the PDE model parameters using the WT MRRs results and the DSM priors. \DIFaddbeginFL \DIFaddFL{In brackets in the first line we added the equivalent daily mortality rate value, for ease of comparison with other studies.}\DIFaddendFL }
\end{table}
...
The dispersal of the DSM mosquitoes is balanced by the mortality rate. Because of this, the DSM are not really expected to disperse far from their release site, with the expected number of mosquitoes per cell delineated by the red and orange contours in Figure \ref{fig:plotSpread}. For instance, while the spread is expected to extend on average to up to $500$m away from the release location by day $2$ (\DIFdelbegin \DIFdel{with $1\%$ chance that it extends further }\DIFdelend \DIFaddbegin \DIFadd{there is a probability of $0.99$ or more  of not finding a single mosquito further away}\DIFaddend ), the extent then contracts quickly to a limited area (less than $250$m from release location) by day $5$, to finally about $150$m away from the release location at day $12$.
